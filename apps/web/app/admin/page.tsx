    ...
    <main className="admin-container">
      <header className="admin-header">
        <div>
          ...
          <p className="subtitle">System Health & AI Generation Hub</p>
        </div>
                ...
                <tbody>
                  {stats.apiHits.map((h: any, i: number) => (
                    <tr key={i}>
                      ...
                      <td className="time">{new Date(h.last_call).toLocaleString()}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <style jsx>{`
        ...
        .count { font-weight: 700; font-family: monospace; font-size: 1.1rem; }
